...
schedule.every().day.at("06:55").do(veg_price)  #Every morning 6:15 A.M  - Vegetable price
schedule.every().day.at("06:56").do(tamil_news,chennai_mor_id,chennai_mor_filename)  #Morning news chennai
schedule.every().day.at("06:58").do(tamil_news,trichy_id,trichy_filename)  #Afternoon News - Trichy
schedule.every().day.at("06:59").do(tamil_news,pudhucherry_id,pudhucherry_filename)  #Evening news Pudhucherry
schedule.every().day.at("07:00").do(tamil_news,chennai_evening_id,chennai_evening)  #Evening news chennai
